...
class DetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var prov = Provider.of<DetailProvider>(context);
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  '${prov.coinlist.current_price}',
                  style: TextStyle(
                      fontSize: 20,
                      color: prov.coinlist.percentchange_7d > 0
                          ? Colors.green
                          : Colors.red),
                ),
                Text(
                  '${prov.coinlist.percentchange_24h}%',
                  style: TextStyle(
                      fontSize: 20,
                      color: prov.coinlist.percentchange_24h > 0
                          ? Colors.green
                          : Colors.red),
                ),
                SizedBox(
                ...
                Html(data: prov.coinlist.description, style: {
                  "body": Style(
                    color: theme ? Colors.white : Colors.black,
